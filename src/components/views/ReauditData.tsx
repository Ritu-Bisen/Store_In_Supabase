...
export default () => {
    ...
    // Debug logging
    useEffect(() => {
        console.log("=== REAUDITING DATA DEBUG ===");
        ...
        if (tallyEntrySheet.length > 0) {
            ...
            console.log("planned3:", firstItem.planned3);
            console.log("actual3:", firstItem.actual3);
        }
    ...
    useEffect(() => {
        ...
        const pendingItems = filteredByFirm.filter((i) => {
            const hasPlanned = i.planned3 && i.planned3.trim() !== '';
            const hasActual = i.actual3 && i.actual3.trim() !== '';
                ...
                <Tabs defaultValue="pending">
                    ...
                    <TabsContent value="pending">
                        {pendingData.length > 0 ? (
                            ...
                            <div className="text-center p-8 border rounded-lg">
                                <p className="text-muted-foreground">No pending reauditing entries found</p>
                            </div>
                        )}
                    </TabsContent>
                    <TabsContent value="history">
                        {historyData.length > 0 ? (
                            ...
                            <div className="text-center p-8 border rounded-lg">
                                <p className="text-muted-foreground">No reauditing history entries found</p>
                            </div>
                        )}
                    </TabsContent>
                </Tabs>
                        ...
                        <Form {...form}>
                            ...
                            >
                                <DialogHeader className="space-y-1">
                                    <DialogTitle>Reaudit Tally Entry</DialogTitle>
                                    <DialogDescription>
